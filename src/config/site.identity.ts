export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'lorenaslinks',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Lorenaslinks',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'lorenaslinks.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://lorenaslinks.com',
